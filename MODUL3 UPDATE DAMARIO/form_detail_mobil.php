...
<html lang="en">
    ...
    <body>
        <?php 
            ...
            $sql=mysqli_query($connect,"select * from showroom_mobil where id= '$id'");
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="string" class="form-control" name="brand_mobil" id="brand_mobil" value='<?= $result["brand_mobil"]; ?>' placeholder=""disabled>
